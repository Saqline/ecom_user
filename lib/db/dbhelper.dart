...
import 'package:ecom_user/page/rating_model.dart';
...
class DbHelper {
  ...
  static const String collectionUser = 'UserE';
  static const String collectionCart = 'Cart';
  static const String collectionOrder = 'Order';
  static const String collectionOrderDetails = 'OrderDetils';
  ...
  static Future<void> updateProduct(String pid, Map<String, dynamic> map) =>
      _db.collection(collectionProduct).doc(pid).update(map);
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getAllOrdersByUserId(
          String uid) =>
      _db
